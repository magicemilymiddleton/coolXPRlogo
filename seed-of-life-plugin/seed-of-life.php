 ...
 * Version: 2.1.1
 * Author: Emily with Misadventures LLC
...
public function enqueue_assets() {
    ...
    // Always load assets (they're small and may be in header/widgets/sidebars)
    ...
    public function render_shortcode($atts) {
        $atts = shortcode_atts(array(
            ...
            'height' => 500,
            'animation' => 'true',
            'show_controls' => 'true',  // NEW: Option to show/hide controls
            'auto_start' => 'false',     // NEW: Option to auto-start animation
            'layer_effect' => 'true',
        ...
        <div class="seed-of-life-container" data-sol-id="<?php echo esc_attr($atts['id']); ?>">
            ...
            <?php if ($atts['animation'] === 'true' && $atts['show_controls'] === 'true'): ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                if (typeof initSeedOfLife === 'function') {
                    ...
                    setTimeout(function() {
                        if (window.seedOfLife_<?php echo esc_js($atts['id']); ?>.startAnimation) {
                            window.seedOfLife_<?php echo esc_js($atts['id']); ?>.startAnimation();
                        }
                    }, 100);
                    <?php endif; ?>
                }
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <div class="seed-of-life-preview">
                <h2>Live Preview</h2>
                <h3>With Controls (Default)</h3>
                <?php echo do_shortcode('[seed_of_life width="400" height="400"]'); ?>
                
                <h3>Auto-Start, No Controls</h3>
                <?php echo do_shortcode('[seed_of_life width="400" height="400" show_controls="false" auto_start="true"]'); ?>
            </div>
            ...
            <div class="seed-of-life-usage">
                ...
                <ul>
                    ...
                    <li><code>animation="true"</code> - Enable animation feature (true/false)</li>
                    <li><code>show_controls="true"</code> - Show control buttons (true/false) - <strong>NEW!</strong></li>
                    <li><code>auto_start="false"</code> - Auto-start animation on load (true/false) - <strong>NEW!</strong></li>
                    <li><code>layer_effect="true"</code> - Enable layered animation effect</li>
                </ul>
                <p>Examples:</p>
                <ul>
                    <li><code>[seed_of_life]</code> - Default with controls</li>
                    <li><code>[seed_of_life auto_start="true"]</code> - Auto-start with controls</li>
                    <li><code>[seed_of_life show_controls="false" auto_start="true"]</code> - Auto-start, no controls</li>
                    <li><code>[seed_of_life width="600" height="600" show_controls="false" auto_start="true"]</code> - Large, auto-animated, no controls</li>
                </ul>
                <p><strong>NEW in v2.1:</strong> Hide control buttons and auto-start the animation on page load!</p>
            </div>
        </div>
